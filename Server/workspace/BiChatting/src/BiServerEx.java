...
//***** 기말 -> 문제를 주면 서버클라이언트 짜서 돌리는거!!! ***** 
public class BiServerEx extends JFrame implements ActionListener {
	...
	private void setup() {
		try {
			listener = new ServerSocket(9999); // 서버 소켓 생성 999번 포트와 바인딩
			socket = listener.accept(); // 접속을 대기
