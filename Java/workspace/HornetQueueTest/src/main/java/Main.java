...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			TextMessage textMessage = session.createTextMessage("TextMessage example");
			CustomMessage customMessage = new CustomMessage();
			customMessage.setTitle("Custom Title");
			customMessage.setContent("Custom Content");
			...
			System.out.print("Received message: " + receivedObjectMessage.toString());
			
			CustomMessage receivedCutsomMessage = (CustomMessage) receivedObjectMessage.getObject();
			System.out.println("Converted message title: " + receivedCutsomMessage.getTitle() + 
