...
public abstract class StandOutWindow extends Service {
     ...
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that will be used
     ...
     *
     * @param context A Context of the application package implementing this class.
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that is managing
     *                the window.
     ...
     * <p>
     * <p>
     * Send Parceleable data in a {@link android.os.Bundle} to a new or existing
     ...
     *                    the sending window.
     * @param toCls       The Service's class extending {@link wei.mark.standout.StandOutWindow} that is
     ...
     * @see #sendData(int, Class, int, int, android.os.Bundle)
     */
    ...
    /**
     * See {@link #show(android.content.Context, Class, int)}.
     *
     * @param context A Context of the application package implementing this class.
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that will be used
     *                to create and manage the window.
    ...
    /**
     * See {@link #hide(android.content.Context, Class, int)}.
     *
     * @param context A Context of the application package implementing this class.
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that is managing
     *                the window.
    ...
    /**
     * See {@link #close(android.content.Context, Class, int)}.
     *
     * @param context A Context of the application package implementing this class.
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that is managing
     *                the window.
    ...
    /**
     * See closeAll(android.content.Context, Class, int).
     *
     * @param context A Context of the application package implementing this class.
     * @param cls     The Service extending {@link wei.mark.standout.StandOutWindow} that is managing
     *                the window.
    ...
    /**
     * See {@link #sendData(android.content.Context, Class, int, int, android.os.Bundle, Class, int)}.
     *
     * @param context     A Context of the application package implementing the class of
     *                    the sending window.
     * @param toCls       The Service's class extending {@link wei.mark.standout.StandOutWindow} that is
    ...
    /**
     * Create a new {@link android.view.View} corresponding to the id, and add it as a child
     ...
     * {@link android.widget.FrameLayout#addView(android.view.View)} to add your view to the frame.
     *
     * @param id    The id representing the window.
     * @param frame The {@link android.widget.FrameLayout} to attach your view as a child to.
     */
     ...
     * <p>
     * <p>
     * You may use any of the flags defined in {@link wei.mark.standout.constants.StandOutFlags}. This
     ...
     * <p>
     * <p>
     * The returned intent will be packaged into a {@link android.app.PendingIntent} to be
    ...
    /**
     * Return a persistent {@link android.app.Notification} for the corresponding id. You
     ...
     * {@link android.app.PendingIntent#FLAG_UPDATE_CURRENT} flag in the notification so
     ...
     *
     * @param id The id of the window.
     * @return The {@link android.app.Notification} corresponding to the id, or null if
    ...
    /**
     * Return a hidden {@link android.app.Notification} for the corresponding id. The system
     ...
     *
     * @param id The id of the window.
     * @return The {@link android.app.Notification} corresponding to the id or null.
     */
     ...
     * when {@link wei.mark.standout.constants.StandOutFlags#FLAG_DECORATION_SYSTEM} is set.
     *
     * @param id The id of the window.
     ...
     * @see {@link android.view.View.OnTouchListener#onTouch(android.view.View, android.view.MotionEvent)}
     */
     ...
     * @param view   The view where the event originated from.
     * @param event  See linked method.
     * @see {@link #onTouchHandleMove(int, wei.mark.standout.ui.Window, android.view.View, android.view.MotionEvent)}
     */
     ...
     * @param view   The view where the event originated from.
     * @param event  See linked method.
     * @see {@link #onTouchHandleResize(int, wei.mark.standout.ui.Window, android.view.View, android.view.MotionEvent)}
     */
     ...
     * {@link #sendData(int, Class, int, int, android.os.Bundle)}.
     *
     ...
     * handles the event with {@link wei.mark.standout.ui.Window#dispatchKeyEvent(android.view.KeyEvent)}.
     *
     * @param id    The id of the window, provided as a courtesy.
     * @param event The key event.
     * @return Return true to cancel the window from handling the key event, or
     * false to let the window handle the key event.
     * @see {@link wei.mark.standout.ui.Window#dispatchKeyEvent(android.view.KeyEvent)}
     */
...
//            }
    ...
    /**
     * Send @link Parceleable data in a {@link android.os.Bundle} to a new or existing
     * windows. The implementation of the recipient window can handle what to do
     ...
     * @link #createAndAttachView(int, android.view.ViewGroup). This means the returned
     ...
     * {@link wei.mark.standout.constants.StandOutFlags#FLAG_DECORATION_SYSTEM} is set, or if your own view
    ...
    public class StandOutLayoutParams extends WindowManager.LayoutParams {
        ...
        public final Parcelable.Creator CREATOR = new Parcelable.Creator() {
            ...
            @Override
            public StandOutLayoutParams createFromParcel(Parcel in) {
                return new StandOutLayoutParams(in);
            }

            @Override
            public StandOutLayoutParams[] newArray(int size) {
                return new StandOutLayoutParams[size];
            }

        };

        public StandOutLayoutParams(Parcel in) {
            readFromParcel(in);
        }
