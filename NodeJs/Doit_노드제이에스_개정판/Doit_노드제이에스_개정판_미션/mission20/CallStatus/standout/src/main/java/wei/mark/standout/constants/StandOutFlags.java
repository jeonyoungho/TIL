...
/**
 * Flags to be returned from {@link wei.mark.standout.StandOutWindow#getFlags(int)}.
 * 
...
public class StandOutFlags {
	 ...
	 * {@link wei.mark.standout.StandOutWindow#getHiddenIcon(int)},
	 * {@link wei.mark.standout.StandOutWindow#getHiddenTitle(int)}, and
	 * {@link wei.mark.standout.StandOutWindow#getHiddenMessage(int)} are implemented, and that
	 ...
	 * {@link wei.mark.standout.StandOutWindow#onTouchHandleResize(int, Window, android.view.View, android.view.MotionEvent)}
	 * . The aspect ratio will not be enforced if you set the width or height of
	 * the window's LayoutParams manually.
	 * 
	 * @see wei.mark.standout.StandOutWindow#onTouchHandleResize(int, Window, android.view.View, android.view.MotionEvent)
	 */
	 ...
	 * 
	 * @see Window#onInterceptTouchEvent(android.view.MotionEvent)
	 */
	 ...
	 * keys.
	 * 
	 * @see {@link wei.mark.standout.StandOutWindow#focus(int)}
	 * @see {@link wei.mark.standout.StandOutWindow#unfocus(int)}
	 * 
	 */
	 ...
	 * {@link wei.mark.standout.StandOutWindow#onFocusChange(int, Window, boolean)}.
	 * 
	 ...
	 * {@link Window#fixCompatibility(android.view.View, int)} on the view returned by the
	 * implementation.
	 * 
	 * @see {@link Window#fixCompatibility(android.view.View, int)}
	 */
	 ...
	 * {@link Window#addFunctionality(android.view.View, int)} on the view returned by the
	 * implementation.
	 * 
	 * @see {@link wei.mark.standout.StandOutWindow#addFunctionality(android.view.View, int)}
	 */
	 ...
	 * 
	 * @see {@link Window#addFunctionality(android.view.View, int)}
	 */
