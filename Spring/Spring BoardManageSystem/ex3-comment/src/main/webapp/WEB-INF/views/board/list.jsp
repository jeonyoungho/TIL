				...
				<table width="100%"
					...
					<c:forEach var="board" items="${list}">
						<tr>
							...
							<td><fmt:parseDate value="${board.regdate}" var="regdate"
									pattern="yyyy-MM-dd" /> <fmt:formatDate value="${regdate}"
									pattern="yyyy-MM-dd" /></td>
							<td><fmt:parseDate value="${board.updateDate}"
									var="updateDate" pattern="yyyy-MM-dd" /> <fmt:formatDate
									value="${updateDate}" pattern="yyyy-MM-dd" /></td>
						</tr>
					</c:forEach>
				</table>
