...
2. MyBatis가 동작할때 Mapper를 인식할 수 있도록 추가적인 설정<br><br>· xml을 이용한 설정 - root-context.xml에 다음 태그 추가<br>&lt;mybatis:scan base-package="org.zerock.mapper"/&gt;<br>· Java를 이용한 설정 - RootConfig.java에 다음 어노테이션 추가<br>
